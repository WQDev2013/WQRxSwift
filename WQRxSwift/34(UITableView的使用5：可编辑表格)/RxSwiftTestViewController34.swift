//
//  RxSwiftTestViewController34.swift
//  WQRxSwift
//
...
class RxSwiftTestViewController34: WQBaseViewController {
    ...
    override func viewDidLoad() {
        ...
        addButton = UIBarButtonItem.init(title: "+", style: UIBarButtonItem.Style.plain, target: nil, action: nil)
    ...
    func test1() {
        ...
        Observable.of(refreshCommand, addCommand, movedCommand, deleteCommand)
            ...
            .share(replay: 1)
            .bind(to: tableView.rx.items(dataSource: RxSwiftTestViewController34.dataSource()))
...
extension RxSwiftTestViewController34 {
    //创建表格数据源
